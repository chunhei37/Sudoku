...
public class SudokuController {
    ...
    @FXML private ComboBox cmbBoxNewGame;
...
//		}
    ...
    // Fill the gridpane with number and text field
    ...
    // creates a new game with the set difficulty
    public void newGameDifficulty()
	{
		...
		String strLevel;
		int intLevel = 0;
		// get value user selected from combobox
		strLevel = cmbBoxNewGame.getValue().toString();
		switch (strLevel)
		{
			case "Easy": intLevel = 8; break;
			case "Medium": intLevel = 5; break;
			case "Hard": intLevel = 3; break;
		}

		PuzzleGenerator myPuzzleGenerator = new PuzzleGenerator();
		myPuzzleGenerator.setLevel(intLevel);
    ...
    // limit ability to enter more than one number
    ...
    // allow user to pick where to save
    public void saveAs() {
    ...
    // open an existing sudoku (.sdg) file
